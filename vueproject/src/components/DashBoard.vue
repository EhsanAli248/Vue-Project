...
<v-container>
    ...
    <v-card color="#3853D8" height="120px" tile flat class="d-flex align-center justify-center" dark>
        <v-row>
            <v-col cols="12" sm="12">
                <h4 class="text-center">Mens Stylish Shoes</h4>
            </v-col>
            <v-col cols="12" sm="12">
                <v-breadcrumbs :items="items" class="justify-center mt-n7" dark>
                    <template v-slot:divider>
                        <v-icon color="light-green">mdi-chevron-right</v-icon>
                ...
                <v-card height="250px" tile flat color="#3890D8">
                    <v-row>
                        <v-col cols="12" sm="4" class="pl-8 pt-5">
                            <v-btn color="black" dark class="withoutuppercase">
                                New
                            </v-btn>
        ...
        <v-row>
            ...
            <v-col cols="12" sm="3" class="mt-n6 pl-0">
                <v-toolbar flat outlined>
                    ...
                    <v-spacer></v-spacer>
                    <v-badge color="#3853D8" content="3" class="mr-2">
                    </v-badge>
                </v-toolbar>
            </v-col>
            <v-col cols="3" class="py-0 pr-0 mt-n3">
                <v-card flat outlined tile>
                    ...
                    <v-list dense class="mt-n5">
                        <!-- <v-list-item v-for="style in styles" :key="style.title"> -->
                            <v-list-item v-for="style in categories" :key="style.title"></v-list-item>
                            <v-list-item-content>
                                <v-list-item-title  class="ml-8"></v-list-item-title>
                ...
                <v-card flat outlined tile>
                    ...
                    <v-toolbar flat>
                        ...
                        <v-text-field placeholder="$32" filled rounded dense class="mx-2"></v-text-field>
                    </v-toolbar>
                    <v-range-slider color="blue" max="50" min="-20"></v-range-slider>
                ...
                <v-card flat outlined>
                    ...
                    <v-chip-group column multiple>
                        <v-chip filter outlined color="black" text-color="black" class="ml-2">
                        </v-chip>
                    ...
                    <v-col cols="12" sm="4" v-for="(cloth,i) in clothes" :key="i" class="cloth.class">
                        <v-hover v-slot:default="{hover}">
                            <v-card height="300" align="center" flat outlined tile>
                                ...
                                <v-img :src="cloth.image" width="200" height="200" contain>
                                </v-img>
...
<v-row>
    ...
    <v-col cols="12" sm="12">
        <h6 class="text-center grey--text">
            Create your account. Set a budget. Write an ad & decide where you would like it to appear.<br> 
            Find the right keywords to target your audience on display, search, video & app ads. 
            Sign Up Today. Appear On Google Search. Only Pay For Results. Promote Your Website. Types:
        </h6>
