        ...
        <v-row>
            <v-col cols="12" sm="4">
                <v-card-text class="white--text pt-0">
                    <h3>Everything is ideal</h3>
                </v-card-text>
                <v-card-text class="grey--text pt-0">
                    Appear On Google Search. Only Pay For Results. Promote Your Website. Types:
                </v-card-text>
                ...
                <v-card-text class="grey-text mt-n4">Shipping and Delivery</v-card-text>
            ...
            <v-col cols="12" sm="2">
                ...
                <v-card-text class="grey--text">CA Supply Chain Act</v-card-text>
            </v-col>
            <v-col cols="12" sm="4">
                ...
                <v-card-text class="grey--text mt-14">Payement Methods</v-card-text>
                <v-toolbar flat color="transparent">
                    <v-spacer></v-spacer>
                    <v-icon large>fab fa-cc-paypal</v-icon>
                    <v-icon class="mx-2" large>fab fa-cc-visa</v-icon>
